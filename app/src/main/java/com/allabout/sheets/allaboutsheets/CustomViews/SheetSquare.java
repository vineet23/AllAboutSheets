package com.allabout.sheets.allaboutsheets.CustomViews;
...
public class SheetSquare extends View {
    ...
    //side1,side2,side3,side4,diagonal1,diagonal2
    Line s1,s2,s3,s4,d1,d2;
    //angle,opposite angle,circle angle
    int setup =0,angle=0,oangle=45,offset=100,cangle=0;
    ...
    protected void onDraw(Canvas canvas) {
        if (setup==0)
        {
            ...
            rectF = new RectF(150,150,getWidth()-150,getHeight()-150);
        ...
        //to rotate the canvas accordingly
        ...
        //rotate the canvas for diagonals
        if (s4.getY2()>=getHeight()-offset&&angle<=45)
        {
            try {
                postInvalidate();
